...
const ReservationForm = () => {
  ...
  const handleCheckboxChange = (label) => {
    setSelectedOptions((prev) =>
      prev.includes(label)
        ? prev.filter((option) => option !== label) // Remove if already selected
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <label className="flex items-center gap-2">
                    ...
                    >
                      ...
                      <option value="Library - Activity Center">Library - Activity Center</option>
                      <option value="Library - Activity Loft">Library - Activity Loft</option>
                      <option value="Library - Discussion Room #1">Library - Discussion Room #1</option>
                      <option value="Library - Discussion Room #2">Library - Discussion Room #2</option>
                      <option value="Library - Discussion Room #3">Library - Discussion Room #3</option>
                      <option value="Library - Discussion Room #4">Library - Discussion Room #4</option>
                      <option value="Library - Discussion Room #5">Library - Discussion Room #5</option>
                      <option value="Library - HERO Learning Commons Auditorium">Library - HERO Learning Commons Auditorium</option>
